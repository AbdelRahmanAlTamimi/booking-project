...
class AircraftController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('AdminDashboard.aircrafts.index', compact('planes', 'totalPlanes', 'searchQuery', 'statusFilter'));
    }
    ...
    public function create()
    {
        ...
        return view('AdminDashboard.aircrafts.create', compact('Plane'));
    }

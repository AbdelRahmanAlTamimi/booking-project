    ...
    {{-- <main id="main" class="main"> --}}
        <div class="col-12">
            <div class="card recent-sales overflow-auto shadow-sm mb-4">
                ...
                <div class="card-body">
                    <!-- Planes Filter Form -->
                    <form method="GET" action="{{ route('aircrafts.index') }}"
                                ...
                                @foreach ($planes as $plane)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <!-- Edit Button -->
                                                <a href="{{ route('aircrafts.edit', $plane->id) }}"
                                                ...
                                                <!-- Delete Button -->
                                                <form id="delete-form-{{ $plane->id }}"
                                                    action="{{ route('aircrafts.destroy', $plane->id) }}" method="POST"
                                                    class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button
                                                        style="width: fit-content; height: fit-content; display: flex; justify-content: center; align-items: center;"
                                                        type="button" onclick="confirmDelete({{ $plane->id }})"

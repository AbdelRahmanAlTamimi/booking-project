          ...
          <div class="col-xxl-4 col-md-6 mb-4">
              <div class="card info-card sales-card" style="background-color: #cce5ff;">
                  <div class="card-body">
                      ...
                      <div class="d-flex align-items-center">
                          <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                              <i class="bi bi-person-lines-fill"></i> <!-- Using a related icon -->
                          </div>
                          <div class="ps-3">
                              <h6>{{$seatsCount}}</h6>
                              <span class="text-success small pt-1 fw-bold">
      ...
      <div class="col-lg-6">
          <div class="card">
              <div class="card-body">
                  ...
                  <!-- Pie Chart by koko -->
                  <canvas id="pieChart" style="max-height: 400px; display: block; box-sizing: border-box; height: 400px; width: 681px;" width="1362" height="800"></canvas>
                  <script>

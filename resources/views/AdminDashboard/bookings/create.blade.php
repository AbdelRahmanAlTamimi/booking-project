                    ...
                    <form action="{{ route('bookings.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="status" name="passenger_id" required>
                                ...
                                <option value="{{ $tickets->passenger_id }}">{{$tickets->passenger ? $tickets->passenger->full_name :'not found' }}</option>
                            @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <option value="{{ $tickets->seat_number }}">{{ $tickets->seat? $tickets->seat->seat_number : "not found" }}</option>
                        @endforeach
                            </select>
